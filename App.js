...
const App = () => {
  ...
  const handleTimeChange = (event, selectedTime) => {
    ...
    if (pickerType === 'start') {
      ...
      // scheduleAlarm(selectedTime.getTime(), 'com.namazmode.SILENT_MODE');
      // scheduleAlarm(autoEnd.getTime(), 'com.namazmode.NORMAL_MODE');
    } else {
      updatedPrayers[selectedPrayerIndex].endTime = selectedTime;

      // scheduleAlarm(selectedTime.getTime(), 'com.namazmode.NORMAL_MODE');
    }
